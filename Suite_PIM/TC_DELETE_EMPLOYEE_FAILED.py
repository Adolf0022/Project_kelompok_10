...
class Test_delete_EMPLOYEE_FAILED(unittest.TestCase):
    def setUp(self): 
        self.driver = webdriver.Chrome(ChromeDriverManager().install())
        
    def test_delete_EMPLOYEE_FAILED(self):
        driver = self.driver
        ...
        time.sleep(4)
        driver.find_element(By.XPATH, '//*[@id="app"]/div[1]/div[2]/div[2]/div/div[2]/div[3]/div/div[2]/div[13]/div/div[9]/div/button[1]' ).click() #BUTTON DELETE
        time.sleep(5)

        driver.find_element(By.XPATH, '//*[@id="app"]/div[3]/div/div/div/div[3]/button[1]' ).click() #BUTTON CANCEL
        time.sleep(5)
